...
namespace FarmFresh.UnitTests.ApplicationCore.Specifications
{
    public class CatalogFilterPaginatedSpecification
    {
        ...
        {
            var spec = new FarmFresh.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, null, null);
        ...
        {
            var spec = new FarmFresh.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, 1, 1);
