...
using FarmFresh.Web.Features.OrderDetails;
using Moq;
...
namespace FarmFresh.UnitTests.MediatorHandlers.OrdersTests
{
    public class GetOrderDetails
    {
        ...
        {
            var request = new FarmFresh.Web.Features.OrderDetails.GetOrderDetails("SomeUserName", 0);
        ...
        {
            var request = new FarmFresh.Web.Features.OrderDetails.GetOrderDetails("SomeUserName", 100);
